(function() {
  ...
  const PAGE_NAV = {
    ...
    personal: [
      ...
      { id: 'slide-3',  label: '03 · 四个方向' },
      { id: 'slide-4',  label: '04 · PART 01' },
      { id: 'slide-5',  label: '05 · 时间线' },
      { id: 'slide-6',  label: '06 · 工具链' },
      { id: 'slide-7',  label: '07 · 模型适配' },
      { id: 'slide-8',  label: '08 · 芯片定义' },
      { id: 'slide-9',  label: '09 · 前沿研究' },
      { id: 'slide-10', label: '10 · 客户交付' },
      { id: 'slide-11', label: '11 · PART 02' },
      { id: 'slide-12', label: '12 · H2 计划' },
      { id: 'slide-13', label: '13 · 量化落地' },
      { id: 'slide-14', label: '14 · XH3 验证' },
      { id: 'slide-15', label: '15 · 能力沉淀' },
      { id: 'slide-16', label: '16 · 推进计划表' },
    ],
  };
